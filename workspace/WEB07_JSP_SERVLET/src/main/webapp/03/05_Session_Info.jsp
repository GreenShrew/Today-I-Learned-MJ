...
<%
	...
	long time_used = (lasttime - createdtime) / 1000;	// 사용시간 (마지막접근시간 - 생성시간) : 밀리초 -> 1000으로 나누어 초 단위로
	
	session.setMaxInactiveInterval(3600);	// 세션의 수명을 설정(단위 : 초)
