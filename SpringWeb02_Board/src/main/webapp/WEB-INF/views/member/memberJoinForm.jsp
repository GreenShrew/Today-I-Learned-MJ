...
<div id="wrap" align="center">
	...
	<form name="frm" method="post" action="memberJoin">
		<table>
			...
			<tr><th>암호 확인</th><td><input type="password" name="pw_check" size="20"> * </td></tr>
		...
		<input type="button" value="로그인 페이지로" onClick="history.go(-1);">
<!-- 		<input type="button" value="로그인 페이지로" onClick="location.href='/'"> 클릭이동 오류! 
			다만, 차후 배울 스프링부트에서는 사용 가능하다. -->
